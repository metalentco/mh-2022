...
<figure class="w-full aspect-video overflow-hidden rounded-[2rem] lg:rounded-[4rem] relative videoBlock">
    <button class="w-full absolute group" id="<?= "button-".$block->id() ?>">
        ...
        <div class="waveTextAnimated w-full absolute top-1/2 left-1/2 text-3xl -translate-x-1/2 -translate-y-1/2 hidden opacity-0 sm:block sm:group-hover:opacity-100">
            <span>V</span>
            <span>I</span>
            <span>D</span>
            <span>E</span>
